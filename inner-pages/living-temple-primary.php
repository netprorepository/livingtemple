<?php
	  ...
	  $primary =$objComm->findRecord('tbl_page',$where1);
?>
...
<body>
 ...
 <section class="sliderinner" style="background:url(<?=BASE_URL?>products/<?=$primary[0]['image2']?>) no-repeat center center; background-size:cover;">
     <h2><?=$primary[0]['title']?></h2>
     <ul>
      <li><a href="<?=BASE_URL?>"><i class="fa fa-home"></i></a></li>
      <li><a href="<?=BASE_URL?>our-school/">Our School</a></li>
      <li><a href="#"><?=$primary[0]['title']?></a></li>
    </ul>
...
<section class="abt-section admission-pg academics-pg">
        ...
        <div class="about-content">
           ...
           <div class="col-md-12 admission-content">
               ...
               <p><?=$primary[0]['description']?></p>
              
              <div class="class-gal">
              
               <?php 
			  $where4 = "img_id='".$primary[0]['code']."'";
