...
$brand_image=$hidden_images;
			...
			$objComm->db_update_recordm('brand_image',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('brand_image','id',$_GET['id']);
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Edit Brand</strong></a> </li> </ul> 
       </div> 
...
<form class="form-horizontal row-border" action="" method="post" enctype="multipart/form-data"> 		   
         ...
         <div class="form-group">
          ...
          <div class="col-md-10"><img src="../products/<?=$result[0]['brand_image']?>"></div> </div>
