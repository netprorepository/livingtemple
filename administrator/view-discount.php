...
?>		  
          ...
          <tr id="tr<?=$query[$i][0]?>"> 		 
			...
			<td class="back_img"><img src="<?=$query[$i]['images']?>" ></td> 
			...
			<td><!--<a href="edit-product.php?id=<?=$query[$i][0]?>" ><i class="icon-pencil"></i></a>--> &nbsp;&nbsp;<a class="delete" onclick="deletedata('offers','id','<?=$query[$i][0]?>')" ><i class="icon-trash"></i></a></td>
