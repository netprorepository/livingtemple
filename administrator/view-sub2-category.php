...
<tbody>  
<?php 
$query=$objComm->findAllRecord('tbl_menu2');
...
?>		  
          <tr id="tr<?=$query[$i][0]?>"> 
			...
			<td><?=$query[$i][2]?></td>
			<td><?=$query[$i][3]?></td> 
			<td><a href="edit-sub-category.php?id=<?=$query[$i][0]?>" ><i class="icon-pencil"></i></a> &nbsp;&nbsp; <a class="delete" onclick="deletedata('tbl_menu2','id','<?=$query[$i][0]?>')" ><i class="icon-trash"></i></a></td>
		  </tr> 
