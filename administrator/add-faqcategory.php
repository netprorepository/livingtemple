...
<?php include 'include/scriptStyle.php' ?>
 ...
 if(isset($_POST['submit']))
			...
			$categorycheck=$objComm->findRecord('tbl_faq_cat',$where);
			if(count($categorycheck)>0)
				...
				$errmessage = $_SESSION['categorymsg'];
					...
					$data=array($category_name,$objComm->strToUrl($category_name),$status);
					$lastId=$objComm->insertWithLastid($fields,$data,'tbl_faq_cat');				
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Add FAQs Category</strong></a> </li> </ul> 
	   </div> 
