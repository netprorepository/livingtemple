...
<div id="container"> 
 ...
 if(isset($_POST['submit']))
			...
			extract($_POST);			
			$date=date("d/m/Y");
			$fields=array('name','image','description','url','status');
			$data=array(mysql_real_escape_string($name),$objComm->uploadfile($_FILES["brand_image"]["name"],$_FILES["brand_image"]["tmp_name"]),mysql_real_escape_string($description),$objComm->strToUrl($name),$status);
			$lastId=$objComm->insertWithLastid($fields,$data,'tbl_blog');				
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Add Blog</strong></a> </li> </ul> 
       </div> 
...
<?php include 'include/leftMenu.php' ?> 
		...
		<form class="form-horizontal row-border" action="" method="post" enctype="multipart/form-data"> 		   
          ...
          <div class="col-md-10"><textarea name="description" rows="8"  id="description" class="form-control"></textarea></div> </div>
		...
		<!---  <div class="form-group">
          ...
          <div class="col-md-10"><input type="text" name='place'  class="form-control"></div> </div> 
		  --->
