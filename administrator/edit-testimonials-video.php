...
$brand_image=$hidden_images;	
			...
			$objComm->db_update_recordm('tbl_testimonials_video',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('tbl_testimonials_video','id',$_GET['id']);
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Edit Video Testimonials</strong></a> </li> </ul> 
       </div> 
...
<?php include 'include/leftMenu.php' ?> 
		...
		<div class="form-group">
		  ...
		  <div class="form-group"><label class="col-md-2 control-label">Video:</label> 
          <div class="col-md-10"> 	
					<input type="text" name='url' class="form-control" value="<?=$result[0]['video']?>">
					<input type="hidden" name='url2' class="form-control" value="<?=$result[0]['video']?>">
		  <br/>
		  <iframe title="YouTube video player" class="youtube-player" type="text/html" 
width="200" height="200" src="http://www.youtube.com/embed/<?=$result[0]['video']?>" frameborder="0" allowFullScreen></iframe>
		  <br/>
		  </div> </div>
