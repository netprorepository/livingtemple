...
<div id="container"> 
 ...
 if(isset($_POST['submit']))
			...
			$data=array($name,$objComm->uploadfile($_FILES["brand_image"]["name"],$_FILES["brand_image"]["tmp_name"]),mysql_real_escape_string($description),$url,$status);
			$lastId=$objComm->insertWithLastid($fields,$data,'tbl_recommended_tools');				
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Add Recommended Tools</strong></a> </li> </ul> 
       </div> 
