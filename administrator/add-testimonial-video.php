...
<div id="container"> 
 ...
 if(isset($_POST['submit']))
			...
			$date=date("d/m/Y");
			$fields=array('name','video','place','status','image');
			$data=array($name,$url3,$place,$status,$objComm->uploadfile($_FILES["image"]["name"],$_FILES["image"]["tmp_name"]));
			$lastId=$objComm->insertWithLastid($fields,$data,'tbl_testimonials_video');				
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Add Video Testimonials</strong></a> </li> </ul> 
       </div> 
