...
<?php include 'include/scriptStyle.php' ?>
 ...
 <?php include 'include/topHeader.php';
			...
			$objComm->db_update_recordm('material',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('material','id',$_GET['id']);
...
<form class="form-horizontal row-border" action="" method="post"> 		   
         ...
         <div class="form-group">
          ...
          <div class="col-md-10"><input type="text" name='material_name' value="<?=$result[0]['material_name']?>" class="form-control"></div> </div> 
