...
$brand_image=$hidden_images;
			...
			$objComm->db_update_recordm('tbl_home_gallery',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('tbl_home_gallery','id',$_GET['id']);
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Edit Gallery</strong></a> </li> </ul> 
       </div> 
