...
<?php include 'include/scriptStyle.php' ?>
 ...
 <?php include 'include/topHeader.php';
			...
			$objComm->db_update_recordm('tbl_faq_cat',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('tbl_faq_cat','id',$_GET['id']);
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Edit FAQs Category</strong></a> </li> </ul> 
       </div> 
