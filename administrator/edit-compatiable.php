...
<?php include 'include/scriptStyle.php' ?>
 ...
 <?php include 'include/topHeader.php';
			...
			$objComm->db_update_recordm('compatible',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('compatible','id',$_GET['id']);
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Edit Compatible</strong></a> </li> </ul> 
       </div> 
...
<form class="form-horizontal row-border" action="" method="post"> 		   
         ...
         <div class="form-group">
          <label class="col-md-2 control-label">Compatible :</label> 
          <div class="col-md-10"><input type="text" name='compatible_name' value="<?=$result[0]['compatible_name']?>" class="form-control"></div> </div> 
