...
$brand_image=$hidden_images;
			...
			$objComm->db_update_recordm('tbl_testimonials',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('tbl_testimonials','id',$_GET['id']);
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Edit Testimonials</strong></a> </li> </ul> 
       </div> 
