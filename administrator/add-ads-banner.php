...
<?php include 'include/scriptStyle.php' ?>
 ...
 if(isset($_POST['submit']))
			...
			extract($_POST);			
			$date=date("d/m/Y");
			$fields=array('image','url','status');
			$data=array($objComm->uploadfileadds($_FILES["brand_image"]["name"],$_FILES["brand_image"]["tmp_name"]),mysql_real_escape_string($url),$status);
			$lastId=$objComm->insertWithLastid($fields,$data,'tbl_adds_banner');				
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Add Ads Banner</strong></a> </li> </ul> 
       </div> 
