...
$brand_image=$hidden_images;
			...
			$where=' where id="1"';
			$objComm->db_update_recordm('tbl_ftag',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('tbl_ftag','id',1);
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Update About Living Page</strong></a> </li> </ul> 
       </div> 
...
<form class="form-horizontal row-border" action="" method="post" enctype="multipart/form-data"> 
       <div class="form-group">
          ...
          <div class="col-md-10"><input type="text" name='short'    class="form-control" value="<?=$result[0]['short']?>"></div> </div>
  ...
  <div class="form-group">
          ...
          <div class="col-md-10"> <textarea name='description' id="description1" rows="6" class="form-control" ><?=$result[0]['description']?></textarea></div> </div>
