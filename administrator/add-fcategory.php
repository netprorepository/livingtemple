...
<?php include 'include/scriptStyle.php' ?>
 ...
 if(isset($_POST['submit']))
			...
			$categorycheck=$objComm->findRecord('tbl_fcategory',$where);
			if(count($categorycheck)>0)
				...
				$errmessage = $_SESSION['categorymsg'];
					...
					$lastId=$objComm->insertWithLastid($fields,$data,'tbl_fcategory');				
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Add Features Category</strong></a> </li> </ul> 
	   </div> 
...
<form class="form-horizontal row-border" action="" method="post"  enctype="multipart/form-data"> 		   
         ...
         <div class="form-group">
          <label class="col-md-2 control-label">Features Category Name:</label> 
