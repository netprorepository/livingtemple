...
<?php include 'include/scriptStyle.php' ?>
 ...
 <?php include 'include/topHeader.php';
			...
			$objComm->db_update_recordm('barcode',$update_arr,$where); 		
			$message=UPDATE_DATA_MASS_SUSS;
			}
			
			$result=$objComm->singleRowFetch('barcode','id',$_GET['id']);
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Edit Barcode</strong></a> </li> </ul> 
       </div> 
...
<form class="form-horizontal row-border" action="" method="post" enctype="multipart/form-data"> 		   
         ...
         <div class="form-group">
          ...
          <div class="col-md-10"><input type="text" name='barcode' value="<?=$result[0]['barcode']?>" class="form-control"></div> </div> 
