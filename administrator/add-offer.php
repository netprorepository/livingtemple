...
$fields=array('category_id','subcategory_id','name','code','description','price','images','color','material','delivery_time','date','status','discount_price','product_type','brand','compatiable','suitable_device','box_contents','finish','images1','images2','images3','images4','images5','images6','images7','images8','images9','images10','quantity','color_map','seo_title','seo_keyword','seo_keyword1','seo_keyword2','seo_keyword3','seo_keyword4','seo_description','itemcondition_id','url','latest','media_type');
			$data=array($category_id,$subcategory_id,$seo_title,$code,$description,$price,$images,$color,$material,$delivery_time,$date,$status,$discount_price,$product_type,$brand,$compatiable,$suitable_device,$box_contents,$finish,$images1,$images2,$images3,$images4,$images5,$images6,$images7,$images8,$images9,$images10,$quantity,$color_map,$seo_title,$seo_keyword,$seo_keyword1,$seo_keyword2,$seo_keyword3,$seo_keyword4,$seo_description,$itemcondition_id,$url,$latest,$media_type);
...
name='$name', code='$code',	description='$description', price='$price',	images='$images', color='$color',
phone_model='$phone_model',	delivery_time='$delivery_time',	date='$date', status='$status',	discount_price='$discount_price',
product_type='$product_type', brand='$brand', compatiable='$compatiable', suitable_device='$suitable_device',
box_contents='$box_contents', finish='$finish',	images1='$images1',	images2='$images2',	images3='$images3',
images4='$images4',	images5='$images5',	images6='$images6',	images7='$images7',	images8='$images8',	images9='$images9',
images10='$images10', quantity='$quantity',	color_map='$color_map',	seo_title='$seo_title',	seo_keyword='$seo_keyword',
seo_keyword1='$seo_keyword1', seo_keyword2='$seo_keyword2',	seo_keyword3='$seo_keyword3', seo_keyword4='$seo_keyword4',
seo_description='$seo_description',	itemcondition_id='$itemcondition_id', url='$url', media_type='$media_type', latest='$latest'
where code='$code'";
...
<div id="content"> 
	   ...
	   <li> <a href="javascript:void(0);"><strong>Add Offer</strong></a> </li> </ul> 
	   <div class="dowload_demo"><a href="excel/latestproject.csv"><strong>Download Demo</strong></a> </div>
       </div> 
...
<?php include 'include/leftMenu.php' ?> 
        ...
        <?php if(isset($message)) echo $message; ?>
		 ...
		 <div class="form-group">
          ...
          <div class="col-md-10"><a onclick='window.open ("<?=BASE_URL?>administrator/add-latest-offers.html",
"mywindow","menubar=1,resizable=1,width=350,height=250");'> Example </a>   <button id="btn-load" name="uploadData" class="btn btn-primary btn-primary-margin-left" data-loading-text="Loading...">Upload Data</button></div> </div>
		 ...
		 <div class="form-group">
		  ...
		  <div class="form-group">
          <label class="col-md-2 control-label"></label> 
          <div class="col-md-10"><a onclick='window.open ("<?=BASE_URL?>administrator/update-latest-offers.html",
"mywindow","menubar=1,resizable=1,width=350,height=250");'> Example </a>   <button id="btn-load" name="UpdateData" class="btn btn-primary btn-primary-margin-left" data-loading-text="Loading...">Update Data</button></div> </div>
		 ...
		 <div class="form-group">
		  ...
		  <div class="form-group">
          <label class="col-md-2 control-label"></label> 
          <div class="col-md-10"><a onclick='window.open ("<?=BASE_URL?>administrator/delete-latest-offers.html",
